...
#* erase
pca12_plot_TR <- plot_pca_compare(pca_embeddings, pca_embeddings_py, legend_position = "TR", save = glue::glue("{output_base_path}/plots/pca_scatterplot_12_TR.tiff"))
pca12_plot_TL <- plot_pca_compare(pca_embeddings, pca_embeddings_py, legend_position = "TL", save = glue::glue("{output_base_path}/plots/pca_scatterplot_12_TL.tiff"))
pca12_plot_BR <- plot_pca_compare(pca_embeddings, pca_embeddings_py, legend_position = "BR", save = glue::glue("{output_base_path}/plots/pca_scatterplot_12_BR.tiff"))
pca12_plot_BL <- plot_pca_compare(pca_embeddings, pca_embeddings_py, legend_position = "BL", save = glue::glue("{output_base_path}/plots/pca_scatterplot_12_BL.tiff"))
```
