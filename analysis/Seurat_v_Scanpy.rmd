...
seu_matrix_generation_method_version <- "0.24.4"
...
scan_matrix_generation_method_version <- "0.24.4"
...
seu_used_batch <- ifelse(seu_kb_major_version >= 28, TRUE, FALSE)
scan_used_batch <- ifelse(scan_kb_major_version >= 28, TRUE, FALSE)
