...
if r.scan_cell_fraction_after_downsampling != "1_0":
    ...
    np.random.seed(r.scan_cell_downsample_seed)
...
Find markers Scanpy
```{python}
sc.tl.rank_genes_groups(adata, r.scanpy_clustering_algorithm, use_raw=True, method='wilcoxon', corr_method=r.scanpy_correction_method, pts = True, tie_correct = r.scanpy_tie_correct)
```
