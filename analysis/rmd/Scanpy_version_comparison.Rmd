...
scanpy1_version <- "1.9.5"
scanpy2_version <- "1.4.6"
...
scan1_data_path_base <- "/workspace/scanpy195/data_files"
scan2_data_path_base <-  "/workspace/scanpy146/data_files"
...
output_base_path <- glue::glue("/workspace/scanpy19vsscanpy14")
...
```{python}
adata1_all_genes = sc.read_h5ad(f"{r.scan1_data_path_base}/adata1_object_all_genes.h5ad")
adata2_all_genes = sc.read_h5ad(f"{r.scan2_data_path_base}/adata1_object_all_genes.h5ad")
```
...
```{python}
adata1 = sc.read_h5ad(f"{r.scan1_data_path_base}/adata1.h5ad")
adata2 = sc.read_h5ad(f"{r.scan2_data_path_base}/adata1.h5ad")
```
...
```{r}
result1 <- readRDS(glue("{scan1_data_path_base}/markers_Full.rds"))
result2 <- readRDS(glue("{scan2_data_path_base}/markers_Full.rds"))
