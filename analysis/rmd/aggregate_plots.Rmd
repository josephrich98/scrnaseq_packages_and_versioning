...
type_downsampled <- "read" # "read" or "cell"
margin_correct <- 0.05
```
...
get_stats_filepath <- function(set, frac_str, package, type_downsampled, seed) {
    ...
    if (type_downsampled == "read") {
        downsample_string <- glue("cell_fraction_{cell_fraction_downsampled_for_read_downsample_comparisons}/read_fraction_{package}1_1_0_vs_{package}2_{frac_str}_seed{seed}")
    } else if (type_downsampled == "cell") {
        downsample_string <- glue("cell_fraction_{package}1_1_0_vs_{package}2_{frac_str}/read_fraction_{read_fraction_downsampled_for_cell_downsample_comparisons}_seed{seed}")
    }
