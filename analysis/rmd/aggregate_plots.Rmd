...
print(glue::glue("frac_list = {frac_list}. downsampled_seeds_list = {downsampled_seeds_list}. Please make sure you have run each combination of these downsampled {type_downsampled} fractions and seeds before running this notebook."))
```
...
```{r}
if (download_data) {
    download_box(downsampled_data_file_link, data_name_from_download, data_path_root)
}
```
...
if r.download_data and not r.doi == "":
...
variable_sets <- list(
    ...
    list(
        ...
        ideal_value = 0,
        seurat_noise_value = 0.0510741845942693,
        scanpy_noise_value = 0,
    ...
    list(
        ...
        ideal_value = 1,
        seurat_noise_value = 0.990775786143719,
