...
Select yaml file
```{r}
yaml_file <- "Supp_Fig8"  # Supp_Fig8, Supp_Fig8_DE, Supp_Fig10, Supp_Fig16_scan
```
...
if r.scan1_cell_fraction_after_downsampling != "1_0":
    ...
    np.random.seed(r.scan1_cell_downsample_seed)
...
if (scan1_cell_fraction_after_downsampling != "1_0") {
    res_mat1 <- res_mat1[, py$sampled_cells_indices1]
}
...
if r.scan2_cell_fraction_after_downsampling != "1_0":
    current_state = np.random.get_state()
    np.random.seed(r.scan2_cell_downsample_seed)
...
if (scan2_cell_fraction_after_downsampling != "1_0") {
    res_mat2 <- res_mat2[, py$sampled_cells_indices2]
}
