...
seurat1_version <- "4.3.0"
seurat2_version <- "5.0.1"
...
output_base_path <- glue::glue("{project_base_path}/output/{data_name}/seuratv{seurat1_version}_vs_seuratv{seurat2_version}/input_{data_input}/kb0_28_0_raw_generated_sa/cell_fraction_1_0/read_fraction_1_0")
...
Load data
```{r}
seu1 <- readRDS(glue("{project_base_path}/output/{data_name}/seuratv{seurat1_version}/input_default/kb0_28_0_raw_generated_sa/cell_fraction_1_0/read_fraction_1_0/data_files/seu1.rds"))
markers_seu1 <- readRDS(glue("{project_base_path}/output/{data_name}/seuratv{seurat1_version}/input_default/kb0_28_0_raw_generated_sa/cell_fraction_1_0/read_fraction_1_0/data_files/markers_full.rds"))

seu2 <- readRDS(glue("{project_base_path}/output/{data_name}/seuratv{seurat2_version}/input_default/kb0_28_0_raw_generated_sa/cell_fraction_1_0/read_fraction_1_0/data_files/seu1.rds"))
markers_seu2 <- readRDS(glue("{project_base_path}/output/{data_name}/seuratv{seurat2_version}/input_default/kb0_28_0_raw_generated_sa/cell_fraction_1_0/read_fraction_1_0/data_files/markers_full.rds"))
```
...
FROM THIS POINT ON, MAKE SURE I AM USING MARKERS DATAFRAMES WITH THE SAME CLUSTER INFO (if that comes from defaults then great, otherwise do a seu1 input run as well)
```{r}
...
upset_marker_gene_only <- make_upset_seurat(vectorized_seu1_filtered_markers, vectorized_seu2_filtered_markers, comparison = "Marker Gene", group_names = seurat_group_names, save = "4.tiff")
...
upset_markers_all <- make_upset_seurat(vectorized_seu1_markers, vectorized_seu2_markers, comparison = "Marker", group_names = seurat_group_names, save = "3.tiff")
...
logFC_scatterplot <- plot_scatterplot_de_logfc(markers2, group1_name = seu1_name, group2_name = seu2_name, save = "1.tiff", outliers_excluded = FALSE)
pvaladj_scatterplot <- plot_scatterplot_de_wilcoxon(markers2, group1_name = seu1_name, group2_name = seu2_name, save = FALSE, outliers_excluded = FALSE)

logFC_scatterplot_with_legend <- plot_scatterplot_de_logfc(markers2, group1_name = seu1_name, group2_name = seu2_name, save = "2.tiff", outliers_excluded = FALSE, show_legend = TRUE)
