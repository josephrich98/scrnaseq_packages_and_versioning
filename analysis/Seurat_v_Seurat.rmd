...
seu1_matrix_generation_method <- "kb" # str["kb", "cellranger"]
seu1_matrix_generation_method_version <- "0.28.0"
seu1_matrix_include_unspliced <- FALSE # kb only; if TRUE --> .total.mtx (kb SUA); if FALSE --> .cell.mtx (KB SA) or .mtx (older versions of KB)
...
seu2_matrix_generation_method <- "kb" # str["kb", "cellranger"]
seu2_matrix_generation_method_version <- "0.28.0"
...
seu1_data_path <- "/workspace/analysis/count_matrix_collection/SC3_v3_NextGem_SI_PBMC_10K/kallisto50_raw_feature_bc_matrix_collection/frac1_0_seed0"  # "/workspace/analysis/count_matrix_collection/SC3_v3_NextGem_SI_PBMC_10K/kallisto50_raw_feature_bc_matrix_collection/frac1_0_seed0"  # NULL for default path
seu2_data_path <- "/workspace/analysis/count_matrix_collection/SC3_v3_NextGem_SI_PBMC_10K/kallisto50_2_raw_feature_bc_matrix_collection/frac1_0_seed0"  # NULL for default path
output_base_path <- "/workspace/analysis/output/SC3_v3_NextGem_SI_PBMC_10K/seuratv4.3.0/input_seu1/seu1_cellranger7_2_0_WITHOUT_introns_vs_seu2_cellranger6_1_2_raw_generated_sa/cell_fraction_1_0/read_fraction_1_0" # "/workspace"   # NULL for default path

# Output path specifications
seu1_name <- "Kallisto50_1"  # Must have no spaces
seu2_name <- "Kallisto50_2"  # Must have no spaces
save_data <- FALSE
dpi <- 350
...
#* erase
save_path_TR <- ifelse(save_data, glue::glue("{output_base_path}/plots/pca_scatterplot_12_TR.tiff"), FALSE)
save_path_TL <- ifelse(save_data, glue::glue("{output_base_path}/plots/pca_scatterplot_12_TL.tiff"), FALSE)
save_path_BR <- ifelse(save_data, glue::glue("{output_base_path}/plots/pca_scatterplot_12_BR.tiff"), FALSE)
save_path_BL <- ifelse(save_data, glue::glue("{output_base_path}/plots/pca_scatterplot_12_BL.tiff"), FALSE)

pca12_plot_TR <- plot_pca_compare(pca_embeddings1, pca_embeddings2, group1_name = "Seurat1", group2_name = "Seurat2", legend_position = "TR", group_labels = unlist(seurat_group_names), save = save_path_TR)
pca12_plot_TL <- plot_pca_compare(pca_embeddings1, pca_embeddings2, group1_name = "Seurat1", group2_name = "Seurat2", legend_position = "TL", group_labels = unlist(seurat_group_names), save = save_path_TL)
pca12_plot_BR <- plot_pca_compare(pca_embeddings1, pca_embeddings2, group1_name = "Seurat1", group2_name = "Seurat2", legend_position = "BR", group_labels = unlist(seurat_group_names), save = save_path_BR)
pca12_plot_BL <- plot_pca_compare(pca_embeddings1, pca_embeddings2, group1_name = "Seurat1", group2_name = "Seurat2", legend_position = "BL", group_labels = unlist(seurat_group_names), save = save_path_BL)
```
