...
seu2_read_downsample_seed <- "100" # random seqtk seed for downsampling reads - 0 for no downsampling, integer >1 for downsampled seed
...
seu2_read_fraction_after_downsampling <- "0.04" # fraction of reads after downsampling - any number from (0,1.0]
...
seu1_data_path <- NULL  # NULL for default path
seu2_data_path <- NULL  # NULL for default path
output_base_path <- "/workspace/reads_downsampled_04_SEU"  # NULL for default path
