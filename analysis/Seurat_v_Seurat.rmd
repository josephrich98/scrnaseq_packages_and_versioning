...
seu2_matrix_generation_method_version <- "0.24.4"
...
data_input <- "seu1" # str["default", "seu1", "seu2"]
...
seu1_data_path <- "/workspace/analysis/count_matrix_collection/SC3_v3_NextGem_SI_PBMC_10K/kb28_raw_generated_WITHOUT_dlist/frac1_0_seed0"  # NULL for default path
seu2_data_path <- NULL  # NULL for default path
output_base_path <- "/workspace/analysis/output/SC3_v3_NextGem_SI_PBMC_10K/seuratv4.3.0/input_seu1/seu1_kb28_WITHOUT_dlist_vs_kb24/cell_fraction_1_0/read_fraction_1_0"   # NULL for default path

# Output path specifications
seu1_name <- "Kallisto50_no_dlist"
seu2_name <- "Kallisto46"
save_data <- TRUE
dpi <- 350
