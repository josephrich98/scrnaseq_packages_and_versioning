...
scan1_data_path <- NULL  # NULL for default path
scan2_data_path <- NULL  # NULL for default path
output_base_path <- NULL   # NULL for default path

# Output path specifications
scan1_name <- "full"  # Must have no spaces
scan2_name <- "downsampled"  # Must have no spaces
save_data <- FALSE
dpi <- 350
project_base_path <- "/workspace/analysis"  # Only needed if using default input/output paths
data_name <- "5k_pbmc_v3"  # Only needed if using default input/output paths
...
#* erase
pca12_plot_TR <- plot_pca_compare(pca_embeddings1, pca_embeddings2, group1_name = "Scanpy1", group2_name = "Scanpy2", legend_position = "TR", group_labels = unlist(scanpy_group_names), save = glue::glue("{output_base_path}/plots/pca_scatterplot_12_TR.tiff"))
pca12_plot_TL <- plot_pca_compare(pca_embeddings1, pca_embeddings2, group1_name = "Scanpy1", group2_name = "Scanpy2", legend_position = "TL", group_labels = unlist(scanpy_group_names), save = glue::glue("{output_base_path}/plots/pca_scatterplot_12_TL.tiff"))
pca12_plot_BR <- plot_pca_compare(pca_embeddings1, pca_embeddings2, group1_name = "Scanpy1", group2_name = "Scanpy2", legend_position = "BR", group_labels = unlist(scanpy_group_names), save = glue::glue("{output_base_path}/plots/pca_scatterplot_12_BR.tiff"))
pca12_plot_BL <- plot_pca_compare(pca_embeddings1, pca_embeddings2, group1_name = "Scanpy1", group2_name = "Scanpy2", legend_position = "BL", group_labels = unlist(scanpy_group_names), save = glue::glue("{output_base_path}/plots/pca_scatterplot_12_BL.tiff"))
```
