...
scan2_read_fraction_after_downsampling <- "0.04" # fraction of reads after downsampling - any number from (0,1.0]

scan1_cell_fraction_after_downsampling <- "1.0" # fraction of cells after downsampling - any number from (0,1.0]
scan2_cell_fraction_after_downsampling <- "1.0" # fraction of cells after downsampling - any number from (0,1.0]
...
if (include_seeds_in_file_paths) {
    if (scan1_read_downsample_seed == scan2_read_downsample_seed) {
